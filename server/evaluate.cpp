...
string HandScore::to_string() const {
...
// PRE: size of input must be 5
HandScore Evaluator::evaluate_five_card_hand(vector<Card>& hand) {
...
HandScore Evaluator::evaluate_table(vector<Card> player, vector<Card> board) {
